...
BOT_NAME = "magicthegathering"

SPIDER_MODULES = ["magicthegathering.spiders"]
NEWSPIDER_MODULE = "magicthegathering.spiders"
...
SPIDERMON_SPIDER_OPEN_MONITORS = {
    "magicthegathering.monitors.SpiderOpenMonitorSuite",
}
SPIDERMON_SPIDER_CLOSE_MONITORS = {
    "magicthegathering.monitors.SpiderCloseMonitorSuite",
}
SPIDERMON_PERIODIC_MONITORS = {
    "magicthegathering.monitors.PeriodicMonitorSuite": 3600,  # time in seconds
}
